import { MessageSquare, Terminal, Folder, GitBranch, ClipboardCheck, Rocket, type LucideIcon } from 'lucide-react';
...
const BASE_TABS: BuiltInTab[] = [
  ...
  { kind: 'builtin', id: 'delivery', labelKey: 'tabs.delivery', icon: Rocket },
